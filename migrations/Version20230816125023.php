...
final class Version20230816125023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, tax_id INT DEFAULT NULL, coupon_id INT DEFAULT NULL, price INT NOT NULL, total INT NOT NULL, INDEX IDX_F52993984584665A (product_id), INDEX IDX_F5299398B2A824D8 (tax_id), INDEX IDX_F529939866C5951B (coupon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
